...
class TvRepository private constructor(
        ...
        private val appExecutors: AppExecutors): TvDataSource{


       companion object{
           @Volatile
           private var INSTANCE: TvRepository? = null
           fun getInstance(remoteFilmSource: RemoteFilmSource, localDatSource: TvLocalDatSource, appExecutors: AppExecutors): TvRepository =
                   INSTANCE ?: synchronized(this){
                       TvRepository(remoteFilmSource, localDatSource, appExecutors).apply {
                           INSTANCE = this
                       }
                   }
       }
