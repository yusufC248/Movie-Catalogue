...
class FilmRepository(
    ...
    companion object{
        ...
        fun getInstance(remoteFilmSource: RemoteFilmSource, localDataSource: LocalDataSource, appExecutors: AppExecutors): FilmRepository =
            instance ?: synchronized(this){
                FilmRepository(remoteFilmSource, localDataSource, appExecutors).apply { instance = this }
            }
    }
